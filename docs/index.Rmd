...
```{r echo=TRUE}
# frequencia absoluta da va 'raca/cor' sem considerar na
freq_abs <- table(dados1$cor); freq_abs

# frequencia absoluta da va 'raca/cor' considerando na
freq_abs_na <- table(dados1$cor, useNA = "always"); freq_abs_na
```
...
```{r echo=TRUE}
# frequencia relativa da va 'raca/cor' sem considerar na
prop.table(freq_abs)

# frequencia relativa da va 'raca/cor' considerando na
